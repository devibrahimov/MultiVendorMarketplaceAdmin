                                    ...
                                    @foreach($products as $product)
                                        <tr>
                                            <td class="product-thumbnail text-start ps-0">
                                                <img src="{{\GuzzleHttp\json_decode($product->product[0]->images)[0]}}" alt="product-image" class="w-80 d-inline-block pt-3 pb-3 bg-greylight rounded-6">
                                            </td>
                                            <td class="product-p">
                                                <h6 class="font-xs ls-3 fw-700 text-current mt-1">{{$product->product[0]->name}}</h6>
                                            </td>
