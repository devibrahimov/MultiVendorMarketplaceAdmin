<div class="card   p-4 border-0  ">
    <div class="card-body text-center">
        <figure class="avatar ms-auto me-auto mb-0 mt-0 w100"><img src="https://via.placeholder.com/100x100.jpg" alt="image" class="shadow-sm rounded-circle w-125"></figure>
    ...
    <div class="card-body p-0 mt-4">
        <ul class="list-inline mb-0">
            ...
            <li class="list-inline-item d-block me-0">
                <a href="orders.html" class="pt-2 pb-2 d-flex align-items-center">
            ...
            <li class="list-inline-item d-block me-0">
                <a href="notification.html" class="pt-2 pb-2 d-flex align-items-center">
