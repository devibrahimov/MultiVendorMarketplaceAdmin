        ...
        <div class="col-xl-5 align-items-center  bg-dark-black rounded-3 overflow-hidden py-5">
            ...
            theme-dark-bg" style="max-width: 860px;">
                ...
                <div class="card-body rounded-0 text-start p-4">
                    <h2 class="fw-700 font-xl display2-md-size mb-4 mt-0 white-text text-grey-900">Hesabına Giriş Et
                    </h2>
                    <form action="{{route('shop.login')}}" method="post">
                        ...
                        <div class="col-sm-12 p-10 text-start ">
                            ...
                            <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32 white-text">Mağaza hesabınız yoxdur ?
