            ...
            <div class="col">
                ...
                <div class="row w-100">
                    <div class="col-6">
                        ...
                        <div class="form-group mb-3 w-100">
                            <input class="form-control font-xssss fw-600 text-grey-700 bg-white border" type="number"
                                   max="8" min="1" id="stock" placeholder="0">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="form-group mb-2">
   ...
   function  validateform(){
    ...
    $('.addtechbtn').on('click', function() {
        ...
        var thisIputHtmls = `<div class="row d-flex align-items-center mt-3">
                                                   ...
                                                   <div class="form-group w-25">
                                                       <input type="text" class="techvalue form-control font-xssss
                                                       fw-600    text-grey-700 border" required maxlength="58"
                                                              placeholder="Yaşıl">
                                                   </div>
