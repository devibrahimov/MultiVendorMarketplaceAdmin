                    ...
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-xs-6 p-4 border-start border-bottom rounded-0 posr">
                                ...
                                <a href="#" class="d-block text-center"><img src="{{json_decode($trend['image'][0])}}" alt="product-image" class="w-100 mt-3 mb-3 d-inline-block p-2 pt-0"></a>
                                ...
                                <div class="clearfix"></div>
                                <h2 class="mt-2"><a href="single-product.html" class="text-grey-700 fw-600 font-xsss lh-22 d-block ls-0">{{$trend->name}}</a></h2>
                                <h6 class="font-xss ls-3 fw-700 text-current d-flex"><span class="font-xsssss text-grey-500">$</span>{{$trend->price}} <span class="ms-auto text-grey-500 fw-500 mt-1 font-xsssss">500gm</span></h6>
