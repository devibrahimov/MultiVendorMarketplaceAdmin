...
<!-- Select Plugin Js -->
<script src="/administrator/plugins/bootstrap-select/js/bootstrap-select.js"></script>
...
<!-- Custom Js -->
<script src="/administrator//cdn.datatables.net/1.11.3/js/jquery.dataTables.min.js"></script>
